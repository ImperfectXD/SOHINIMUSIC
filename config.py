...
BOT_USERNAME = getenv("BOT_USERNAME" , "ClassyMusicRobot")
BOT_NAME = getenv("BOT_NAME" , "CLASY")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/legendtosif/CLASSY-MUSIC",)
